package com.example.sistemadealarmado2_0;
...
public class alarma extends AppCompatActivity {
    private EditText t4, t3,t5,t6,t7,t8,t9;
    ...
    int hora, min,dia,mes,anio,hora11;
    String cadenaF, cadenaH,fecha_sistema,hora_sistema;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        admin = new AdminSQLiteOpenHelper(this, var.bd, null, var.version);
        ...
        t5= (EditText) findViewById(R.id.editText2);
        t6= (EditText) findViewById(R.id.editText3);
        t7= (EditText) findViewById(R.id.editText4);
        t8= (EditText) findViewById(R.id.editText5);
        t9= (EditText) findViewById(R.id.editText6);
        servicio();
    }
    ...
    public void llenar(View view) {
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this, var.bd, null, var.version);
    ...
    public void setCurrentDateOnView() {
        ...
        tvDisplayDate = (EditText) findViewById(R.id.editText5);
